...
/**
 * is_leaf - Checkng if a node is either a leaf of a binary tree
 * @node: a node pointer to check
 ...
 * @tree: node root pointer of the tree to find a leaf in.
 *
 ...
 * @tree:  node root pointer of the tree to check.
